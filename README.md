...
5. To assess relationship between hashtag use in video titles and engagement (likes)
6. To assess relationship between video length and engagement (likes)
7. To perform sentiment analysis on video titles
8. To perform topic modeling (LDA) on video titles
9. To display top-performing videos
